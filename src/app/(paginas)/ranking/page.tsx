"use client";
import ListaVideos from "@/components/ranking/ListaVideos";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-between items-center gap-10">
      ...
      <Link href="/home" className="botao nav2 text-lg text-center py-2">Vote</Link>
      <p className="flex-grow items-center pt-3 w-full">
        Os vídeos estão ordenados do mais votado, para o menos votado. Aproveite e descubra a posição do seu vídeo favorito!
        </p>
        {loading ? (
          <p>Carregando...</p>
        ) : (
